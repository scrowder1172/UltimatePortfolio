...
class DataController: ObservableObject {
    ...
    /// The StoreKit product we've loaded for the store.
    ...
    /// Initializes a data controller, either in memory (for testing use suh as previewing),
    ...
    private func delete(_ fetchRequest: NSFetchRequest<NSFetchRequestResult>) {
        ...
        // IMPORTANT⚠️: When performing a batch delete, we need to be sure we read the result back
